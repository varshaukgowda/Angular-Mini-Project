...
//       if (field.show) {
//         this.registrationForm.addControl(field.name, this.fb.control('', field.required ? Validators.required : null));
//       }
//     });
//   }
...
//   ngOnInit() {
//     // Initialize fields from SharedDataService
//     this.fields = this.sharedData.getFields();

//     // Add form controls for fields marked as "Show"
//     this.fields.forEach(field => {
//       if (field.show) {
//         this.registrationForm.addControl(field.name, this.fb.control('', field.required ? Validators.required : null));
//       }
